...
select_nav.getElementById("select-nav");
child = select_nav.childNodes;
...
function over() {
    icon.src="/public/imgs/help/customer-fill.png";
}

// 벗어났을 때 원래의 이미지를 보여줌.
function out() {
    icon.src="/public/imgs/help/customer-stroke.png";
}
