            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul class="list">
                        <li class="keyword1">
                            <div>
                                <img src="<?= URL; ?>public/imgs/1step.png" width="212" height="150">
                            </div>
                        ...
                        <li class="keyword2">
                            <div>
                                <img src="<?= URL; ?>public/imgs/2step.png" width="141" height="150">
                            </div>
                        ...
                        <li class="keyword3">
                            <div>
                                <img src="<?= URL; ?>public/imgs/3step.png" width="192" height="150">
                            </div>
            ...
            <div class="inner">
                ...
                <div class="slideshow-container">
                    ...
                    <div class="mySlides fade">                   
                        <img src="<?= URL; ?>public/imgs/slide1.jpg" style="width:100%">
                    </div>
                    
                    <div class="mySlides fade">
                        <img src="<?= URL; ?>public/imgs/slide2.jpg" style="width:100%">
                    </div>
                    
                    <div class="mySlides fade">
                        <img src="<?= URL; ?>public/imgs/slide3.jpg" style="width:100%">
                    </div> 
                </div>
            </div>
        </div>
