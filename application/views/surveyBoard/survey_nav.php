<link rel="stylesheet" href="<?= URL; ?>public/css/help/notices.css">
    ...
    <div id="main-container" class="se-wrapper">
        <div class="wrapper">
                    ...
                    <nav class="main-nav">
                        <ul class="nav" id="select-nav">
                            <li class="page-title" id="whole_survey">
                                <a href="/surveyBoard/whole_survey/">전체 설문</a>
                            </li>
                            <li class="page-title" id="on_survey">
                                <a href="/surveyBoard/on_survey/">진행 중인 설문</a>
                            </li>
                            <li class="page-title" id="off_survey">
                                <a href="/surveyBoard/off_survey/">종료된 설문</a>
                            </li>
                            <li class="page-title" id="make_survey">
                                <a href="/surveyBoard/make_survey/">설문작성</a>
                            </li>
                        </ul>
                        <div class="navbar">
                            <div class="dropdown">
            ...
            <script type="text/javascript" src="<?= URL; ?>public/js/help/help_nav.js?dd"></script>