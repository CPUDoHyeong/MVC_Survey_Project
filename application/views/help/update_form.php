<link rel="stylesheet" href="<?= URL; ?>public/css/help/notice_board.css?d">

<div class="content">
    <form accept-charset="UTF-8" action="<?= bdUrl('/help/update', $num, $page); ?>" class="edit-user" id="write-form" method="POST">
        <div class="contentbox">
            ...
            <div class="contentbox-content">  
                ...
                <ul>
                    ...
                    <li>
                        <input class="user-input" id="title" name="title" size="30" type="text" value="<?= $row['title'] ?>">
                    </li>
                    <li>
                        <label class="field-name">내용</label>
                    </li>
                    <li>
                        <textarea class="content-input" id="content" name="content"><?= $row['content'] ?></textarea>
                    </li>
                </ul>
            </div>
        </div>
