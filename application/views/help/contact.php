                    ...
                    <div class="contacts">
                        <dl>
                            ...
                            <dd>
                                ...
                                <br>
                                <img id="icon-img" src="<?= URL; ?>public/imgs/help/customer-stroke.png" width="50px" height="50px"/> 
                                </a>
                            </dd>
                        </dl>
                    </div>
    ...
    <div id="support" class="popup" style="display:none;">
        ...
        <iframe width="100%" frameborder="0" scrolling="no" src="<?= URL; ?>application/views/help/customer_support.php">
        </iframe>
        <a class="close" id="close-iframe"></a>
    </div>
  <script src="/public/js/help/contact.js" type="text/javascript"></script>
</body>
</html>